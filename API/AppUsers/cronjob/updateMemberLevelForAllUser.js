...
async function _calculateNewMemberLevel(appUserId) {
  ...
  if (!_totalUserBetRecordAmountInWORKING || _totalUserBetRecordAmountInWORKING.length <= 0 || _totalUserBetRecordAmountInWORKING[0].sumResult === 0) {
  ...
  if (!_totalUserBetRecordAmountInSTANDBY || _totalUserBetRecordAmountInSTANDBY.length <= 0 || _totalUserBetRecordAmountInSTANDBY[0].sumResult === 0) {
  ...
  if (!_totalReferBetRecordAmountInWORKING || _totalReferBetRecordAmountInWORKING.length <= 0 || _totalReferBetRecordAmountInWORKING[0].sumResult === 0) {
  ...
  if (!_totalReferBetRecordAmountInSTANDBY || _totalReferBetRecordAmountInSTANDBY.length <= 0 || _totalReferBetRecordAmountInSTANDBY[0].sumResult === 0) {
