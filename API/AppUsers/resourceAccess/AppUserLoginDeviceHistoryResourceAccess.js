...
const tableName = 'AppUserLoginDeviceHistory';
const primaryKeyField = 'appUserLoginDeviceHistoryId';
...
function _makeQueryBuilderByFilter(filter, skip, limit, startDate, endDate, searchText, order) {
  ...
  if (searchText) {
    ...
    queryBuilder.where(function () {
      this.orWhere('macAddress', 'like', `%${searchText}%`);
    });
  }
