...
const tableName = 'AppUsersSettingResourceAccess';
const primaryKeyField = 'appUserIpAddressId';
...
function _makeQueryBuilderByFilter(filter, skip, limit, startDate, endDate, searchText, order) {
  ...
  if (searchText) {
    queryBuilder.where(function () {
      this.orWhere('ipAddress', 'like', `%${searchText}%`).orWhere('ipAddressType', 'like', `%${searchText}%`);
    });
  }
