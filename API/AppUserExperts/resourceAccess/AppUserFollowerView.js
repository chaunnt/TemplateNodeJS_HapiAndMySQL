...
const tableName = 'AppUserFollowerView';
const rootTableName = 'AppUserFollower';
const primaryKeyField = 'appUserId';

async function createView() {
  const appUserTableName = 'AppUser';
  let fields = [
    `${rootTableName}.appUserFollowerId`,
    `${rootTableName}.appUserId`,
    `${rootTableName}.followerId`,
    `${rootTableName}.investedAmount`,
    `${rootTableName}.availableBalance`,
    `${rootTableName}.growthIndex`,
    `${rootTableName}.investingAmount`,
    `${rootTableName}.minimumInvestmentAmount`,
    `${rootTableName}.maximumInvestmentAmount`,
    `${rootTableName}.stopLossRate`,
    `${rootTableName}.profitRate`,
    `${rootTableName}.copyTradeStatus`,
