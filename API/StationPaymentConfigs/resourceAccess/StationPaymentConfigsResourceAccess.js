...
const tableName = 'StationPaymentConfigs';
    ...
    DB.schema.dropTableIfExists(`${tableName}`).then(() => {
      DB.schema
        .createTable(`${tableName}`, function (table) {
          ...
          table.text('bankConfigs');
          table.text('momoPersonalConfigs');
          table.text('momoBusinessConfigs');
          table.text('vnpayPersonalConfigs');
          table.text('vnpayBusinessConfigs');
          table.text('zalopayBusinessConfigs');
          table.text('zalopayPersonalConfigs');
          timestamps(table);
