...
const tableName = 'CustomerScheduleFailed';

const primaryKeyField = 'customerScheduleFailedId';
    ...
    DB.schema.dropTableIfExists(`${tableName}`).then(() => {
      DB.schema
        .createTable(`${tableName}`, function (table) {
          ...
          table.integer('createdBy'); // Người tạo lịch hẹn
          table.text('inputFail'); // Dữ liệu người dùng bị sai
          timestamps(table);
