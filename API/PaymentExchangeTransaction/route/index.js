...
module.exports = [
  ...
  { method: 'POST', path: '/PaymentExchangeTransaction/user/userExchangeFACHistory', config: UserPaymentExchangeTransaction.userExchangeFACHistory },
  ...
  { method: 'POST', path: '/PaymentExchangeTransaction/user/ExchangeFAC', config: UserPaymentExchangeTransaction.userExchangeFAC },
  { method: 'POST', path: '/PaymentExchangeTransaction/user/ExchangePOINT', config: UserPaymentExchangeTransaction.userExchangePOINT },
  { method: 'POST', path: '/PaymentExchangeTransaction/user/userExchangePOINTHistory', config: UserPaymentExchangeTransaction.userExchangePOINTHistory },
];
