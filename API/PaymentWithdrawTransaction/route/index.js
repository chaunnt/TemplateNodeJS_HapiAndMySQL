...
module.exports = [
  ...
  { method: 'POST', path: '/PaymentWithdrawTransaction/exportData', config: PaymentWithdrawTransaction.exportData },

  { method: 'POST', path: '/PaymentWithdrawTransaction/user/requestWithdrawUSDT', config: PaymentWithdrawTransaction.requestWithdrawUSDT },
  ...
  { method: 'POST', path: '/PaymentWithdrawTransaction/user/withdrawHistoryUSDT', config: PaymentWithdrawTransaction.withdrawHistoryUSDT },
  { method: 'POST', path: '/PaymentWithdrawTransaction/user/requestWithdrawBTC', config: PaymentWithdrawTransaction.requestWithdrawBTC },
  { method: 'POST', path: '/PaymentWithdrawTransaction/user/withdrawHistoryBTC', config: PaymentWithdrawTransaction.withdrawHistoryBTC },
];
