...
const tableName = 'AppUserVehicleService';
const primaryKeyField = 'appUserVehicleServiceId';
const { SERVICE_STATUS } = require('../AppUserVehicleServiceConstants');
    ...
    DB.schema.dropTableIfExists(`${tableName}`).then(() => {
      DB.schema
        .createTable(`${tableName}`, function (table) {
          ...
          table.integer('vehicleServiceId');
          table.integer('serviceStatus').defaultTo(SERVICE_STATUS.ENABLE);
          timestamps(table);
          table.index(primaryKeyField);
          table.index('appUserVehicleId');
          table.index('vehicleServiceId');
          table.index('appUserId');
          table.index('serviceStatus');
        })
        .then(() => {
