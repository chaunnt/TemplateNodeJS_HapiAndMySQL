...
const filterDepositPointWallet = {
  WalletRecordType: WALLET_RECORD_TYPE.DEPOSIT_POINTWALLET,
  WalletId: Joi.number().required(),
};

const filterWithdrawPointWallet = {
...
module.exports = {
  ...
  userHistory: {
    ...
    handler: function (req, res) {
      Response(req, res, 'userHistory');
    },
  },
  userHistoryDepositPointWallet: {
    tags: ['api', `${moduleName}`],
    description: `update ${moduleName}`,
    pre: [{ method: CommonFunctions.verifyToken }],
    auth: {
    ...
    validate: {
      ...
      payload: Joi.object({
        filter: Joi.object(filterDepositPointWallet),
        startDate: Joi.string(),
        endDate: Joi.string(),
        skip: Joi.number().default(0).min(0),
        limit: Joi.number().default(20).max(100),
  ...
  userHistoryWithdrawPointWallet: {
    tags: ['api', `${moduleName}`],
    description: `update ${moduleName}`,
    pre: [{ method: CommonFunctions.verifyToken }],
    auth: {
    ...
    validate: {
      ...
      payload: Joi.object({
        filter: Joi.object(filterWithdrawPointWallet),
        startDate: Joi.string(),
        endDate: Joi.string(),
        skip: Joi.number().default(0).min(0),
        limit: Joi.number().default(20).max(100),
